...
public class pooextraej03 {
    ...
    public static void main(String[] args) {
        Raices incognita1= RaicesService.creaeRaices();
        System.out.println("Discriminante: " + incognita1.getDiscriminante());
        System.out.println("Tiene 2 raices: " + incognita1.tieneRaices());
        System.out.println("Tiene 1 raiz: " + incognita1.tieneRaiz());
        incognita1.calcular();
    }
